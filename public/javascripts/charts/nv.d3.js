...
nv.models.discreteBarChart = function() {
  ...
  var margin = {top: null, right: null, bottom: null, left: null}
    , width = null
    , height = null
  ...
  var showTooltip = function(e, offsetElement) {
    var left = e.pos[0] + ( offsetElement.offsetLeft || 0 ),
        ...
        y = d3.format(',.f')(discretebar.y()(e.point, e.pointIndex)),
        content = tooltip(e.series.key, x, y, e, chart);
...
//set margin.right to 23 to fit dates on the x-axis within the chart
  ...
  var showTooltip = function(e, offsetElement) {
    ...
    var left = e.pos[0] + ( offsetElement.offsetLeft || 0 ),
        top = e.pos[1] + ( offsetElement.offsetTop || 0),
        x = xAxis.tickFormat()(lines.x()(e.point, e.pointIndex)),
        y = d3.format(',.f')(lines.y()(e.point, e.pointIndex)),
        content = tooltip(e.series.key, x, y, e, chart);
...
nv.models.lineWithFocusChart = function() {
  ...
  var margin = {top: null, right: null, bottom: null, left: null}
    , margin2 = {top: 10, right: 0, bottom: 20, left: 0}
    , color = nv.utils.defaultColor()
    , width = null
    , height = null
    , height2 = 100
...
nv.models.stackedAreaChart = function() {
  ...
  var showTooltip = function(e, offsetElement) {
    var left = e.pos[0] + ( offsetElement.offsetLeft || 0 ),
        ...
        y = d3.format(',.f')(stacked.y()(e.point, e.pointIndex)), //Cambiar en caso de que se requiera en %
        content = tooltip(e.series.key, x, y, e, chart);
